...
import { ThemeProvider } from "@/lib/lms/theme";
import { AuthProvider } from "@/lib/lms/auth";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Modern library management: books, students, issues, fines, and reports." },
      { property: "og:title", content: "Athenaeum — Library Management System" },
      { property: "og:description", content: "Modern library management: books, students, issues, fines, and reports." },
